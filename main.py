...
## Data specification 
parser.add_argument("--train_data_path", type = str, default = './source/train/')
parser.add_argument("--test_data_path", type = str, default = './target/test/')
parser.add_argument("--ft_data_path", type = str, default = './target/train/')
...
parser.add_argument("--test_with_ft", type = str2bool, default = False)
